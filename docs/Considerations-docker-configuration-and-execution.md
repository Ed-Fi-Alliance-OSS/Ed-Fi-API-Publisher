...
Any option not present in the template can still be set through an environment variable with the `EdFi__ApiPublisher__Options__` prefix, e.g. `EdFi__ApiPublisher__Options__CursorPagingPartitionCount=8`.
