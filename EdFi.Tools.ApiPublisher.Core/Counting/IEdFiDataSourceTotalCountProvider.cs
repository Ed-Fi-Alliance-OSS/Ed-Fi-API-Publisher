...
public interface IEdFiDataSourceTotalCountProvider
{
...
public class EdFiOdsApiDataSourceTotalCountProvider : IEdFiDataSourceTotalCountProvider
{
    private readonly ISourceEdFiApiClientProvider _sourceEdFiApiClientProvider;
    
    private readonly ILog _logger = LogManager.GetLogger(typeof(EdFiOdsApiDataSourceTotalCountProvider));

    public EdFiOdsApiDataSourceTotalCountProvider(ISourceEdFiApiClientProvider sourceEdFiApiClientProvider)
    {
