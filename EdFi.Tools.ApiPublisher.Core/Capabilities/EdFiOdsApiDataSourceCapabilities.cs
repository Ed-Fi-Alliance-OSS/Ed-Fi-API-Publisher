...
public class EdFiOdsApiDataSourceCapabilities : IDataSourceCapabilities
{
    private readonly ISourceEdFiApiClientProvider _sourceEdFiApiClientProvider;

    private readonly ILog _logger = LogManager.GetLogger(typeof(EdFiOdsApiDataSourceCapabilities));
    
    public EdFiOdsApiDataSourceCapabilities(ISourceEdFiApiClientProvider sourceEdFiApiClientProvider)
    {
