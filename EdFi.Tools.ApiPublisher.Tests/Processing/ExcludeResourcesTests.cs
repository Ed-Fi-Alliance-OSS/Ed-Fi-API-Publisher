...
namespace EdFi.Tools.ApiPublisher.Tests.Processing
{
    ...
    public class ExcludeResourcesTests
    {
        ...
        public class When_excluding_publishing_of_a_resource_and_its_dependents : TestFixtureAsyncBase
        {
            ...
            public void Should_attempt_to_publish_resources_that_are_not_excluded(string resourceCollectionName)
            {
            ...
            [Test]
            public void Should_not_attempt_to_publish_the_resource_to_be_skipped()
            {
            ...
            [Test]
            public void Should_reflect_the_processing_as_an_exclusion_with_its_dependents_in_the_log()
            {
                ...
                var excludeInitializationEvents = events.Where(e 
                    => e.RenderedMessage.Contains("Excluding resource '/ed-fi/schools' and its dependents...")).ToArray();
            ...
            [TestCase("sessions")]
            [TestCase("studentSectionAssociations")]
            public void Should_NOT_attempt_to_publish_resources_that_are_dependent_on_the_excluded_resource(string resourceCollectionName)
            {
            ...
            [TestCase("assessments")] // Dependent on EducationOrganization
            [TestCase("programs")] // Dependent on EducationOrganization
            [TestCase("educationOrganizationNetworkAssociations")] // Dependent on EducationOrganization
            public void Should_NOT_attempt_to_publish_resources_that_are_dependent_on_the_excluded_resources_base_class(string resourceCollectionName)
            {
                // Should not attempt to GET the dependent of the skipped resource
                A.CallTo(
                        () => _fakeSourceRequestHandler.Get(
