...
{{ ""message"": ""Validation of 'DisciplineAction' failed.\\r\\n\\tValidation of 'DisciplineActionStaffs' failed.\\n\\t\\tDisciplineActionStaff[0]: Staff reference could not be resolved.\\n\\t\\tDisciplineActionStaff[2]: Staff reference could not be resolved.\\n""}}";
        ...
        protected override async Task ArrangeAsync()
        {
            ...
            // Configuration
            _changeProcessorConfiguration =
                TestHelpers.CreateChangeProcessorConfiguration(options, _remediationJavaScriptModuleFactory);

            // Configuration
            _changeProcessorConfiguration =
                TestHelpers.CreateChangeProcessorConfiguration(options, _remediationJavaScriptModuleFactory);

            // Create the node JS service for remediations
...
{{ ""message"": ""Validation of 'DisciplineAction' failed.\\r\\n\\tValidation of 'DisciplineActionStaffs' failed.\\n\\t\\tDisciplineActionStaff[0]: Staff reference could not be resolved.\\n\\t\\tDisciplineActionStaff[2]: Staff reference could not be resolved.\\n""}}";
        ...
        protected override async Task ArrangeAsync()
        {
            ...
            // Configuration
            _changeProcessorConfiguration = TestHelpers.CreateChangeProcessorConfiguration(options, _remediationJavaScriptModuleFactory);

            // Create nodeJS service for remediations
