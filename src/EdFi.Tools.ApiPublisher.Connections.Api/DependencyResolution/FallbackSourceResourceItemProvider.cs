...
{
    public Task<(bool success, string itemJson)> TryGetResourceItemAsync(string resourceItemUrl, CancellationToken cancellationToken = default)
        => Task.FromResult((false, null as string));
}
