...
namespace EdFi.Tools.ApiPublisher.Connections.Api.Processing.Handling;

public class ApiStreamResourcePageMessageHandler : IStreamResourcePageMessageHandler
{
    private readonly ILog _logger = LogManager.GetLogger(typeof(ApiStreamResourcePageMessageHandler));
    private readonly ISourceEdFiApiClientProvider _sourceEdFiApiClientProvider;

    public ApiStreamResourcePageMessageHandler(
