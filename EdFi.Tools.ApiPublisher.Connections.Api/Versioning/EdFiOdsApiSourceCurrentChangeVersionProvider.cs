...
public class EdFiOdsApiSourceCurrentChangeVersionProvider : ISourceCurrentChangeVersionProvider
{
    private readonly ILog _logger = LogManager.GetLogger(typeof(EdFiOdsApiSourceCurrentChangeVersionProvider));

    private readonly ISourceEdFiApiClientProvider _sourceEdFiApiClientProvider;

    public EdFiOdsApiSourceCurrentChangeVersionProvider(ISourceEdFiApiClientProvider sourceEdFiApiClientProvider)
    {
