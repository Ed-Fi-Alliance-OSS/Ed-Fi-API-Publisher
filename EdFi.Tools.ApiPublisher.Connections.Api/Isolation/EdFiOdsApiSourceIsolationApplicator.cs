...
public class EdFiOdsApiSourceIsolationApplicator : ISourceIsolationApplicator
{
    private readonly ISourceEdFiApiClientProvider _sourceEdFiApiClientProvider;

    private readonly ILog _logger = LogManager.GetLogger(typeof(EdFiOdsApiSourceIsolationApplicator));
    
    public EdFiOdsApiSourceIsolationApplicator(ISourceEdFiApiClientProvider sourceEdFiApiClientProvider)
    {
